...
public class FarRed {
    ...
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(new Pose2d(62, 16.6, Math.toRadians(180)))
                //PRELOAD
                ...
                .strafeTo(new Vector2d(62, 61), slowConstraint)
                        .waitSeconds(3)
                .strafeToLinearHeading(new Vector2d(38, 32.3), Math.toRadians(180), mediumConstraint)
                .build());
